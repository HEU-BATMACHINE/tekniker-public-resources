...
# Example usage
filename = 'tekniker-inferred.ttl'
parent_dir = os.path.dirname(os.path.abspath(__file__))
file_path = os.path.join(os.path.dirname(parent_dir), '..', filename)
...
context_file_path = os.path.join(os.path.dirname(os.path.dirname(parent_dir)), 'context/context.json')
